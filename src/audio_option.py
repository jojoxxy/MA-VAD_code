...
parser = argparse.ArgumentParser(description='AudioCLIP')
parser.add_argument('--seed', default=234, type=int)
parser.add_argument('--gpus', default=0, type=int, choices=[0,1], help='gpus')

parser.add_argument('--embed-dim', default=512, type=int)
parser.add_argument('--embed-dim-audio', default=512, type=int)
parser.add_argument('--visual-length', default=256, type=int)
parser.add_argument('--visual-width', default=512, type=int)
parser.add_argument('--audio-width', default=1024, type=int)
...
#parser.add_argument('--model-path', default='./model/model_mix.pth')
parser.add_argument('--model-path', default='./model/85.93/model_mix.pth')
