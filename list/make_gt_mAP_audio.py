...
np.save('list/gt_audio_label.npy', np.asanyarray(gt_label, dtype=object))
np.save('list/gt_audio_segment.npy', np.asanyarray(gt_segment, dtype=object))